                ...
                <MDBCol md='5' className='position-relative'>
                    ...
                    <MDBCard className='my-5 bg-glass'>
                        <MDBCardBody className='p-5'>
                            ...
                            <MDBBtn className='w-50 mb-4 center' size='md' style={{ fontSize: '1rem' }}>sign in</MDBBtn>

                            <p className="px-2 mb-1" style={{ color: 'hsl(241, 2%, 35%, 1)' }}>
                                Already Member ?  <br /></p>

                            <MDBBtn outline className='w-50 mb-4 center' onClick={navigateToRegister} style={{ fontSize: '1rem' }}>
                                sign up
                            </MDBBtn>
