                ...
                <MDBCol md='5' className='position-relative'>
                    ...
                    <MDBCard className='my-5 bg-glass'>
                        <MDBCardBody className='p-5'>
                            ...
                            <MDBBtn className='w-100 mb-4 ' size='md' style={{ fontSize: '1rem' }}>sign in</MDBBtn>

                            <p className="px-2 mb-1" style={{ color: 'hsl(241, 2%, 35%, 1)' }}>
                                Already Member ?  <br /></p>

                            <MDBBtn outline className='w-100 mb-3' onClick={navigateToRegister} style={{ fontSize: '1rem' }}>
                                sign up
                            </MDBBtn>
